...
var Carousel = /** @class */ (function (_super) {
    ...
    Carousel.prototype.render = function (_a, _b) {
        var onGifVisible = _a.onGifVisible, onGifRightClick = _a.onGifRightClick, gifHeight = _a.gifHeight, gifWidth = _a.gifWidth, gutter = _a.gutter, _c = _a.className, className = _c === void 0 ? Carousel.className : _c, onGifClick = _a.onGifClick, onGifHover = _a.onGifHover, onGifKeyPress = _a.onGifKeyPress, onGifSeen = _a.onGifSeen, user = _a.user, noResultsMessage = _a.noResultsMessage, hideAttribution = _a.hideAttribution, noLink = _a.noLink, _d = _a.tabIndex, tabIndex = _d === void 0 ? 0 : _d, borderRadius = _a.borderRadius;
        var gifs = _b.gifs;
        var showLoader = gifs.length > 0;
        ...
        return (preact_1.h(pingback_context_manager_1.default, { attributes: { layout_type: 'CAROUSEL' } },
            preact_1.h("div", { class: containerCss },
                gifs.map(function (gif) {
                    return (preact_1.h(gif_1.default, { className: gifCss, gif: gif, key: gif.id, tabIndex: tabIndex, width: gifWidth || js_util_1.getGifWidth(gif, gifHeight), height: gifHeight, onGifClick: onGifClick, onGifHover: onGifHover, onGifKeyPress: onGifKeyPress, onGifSeen: onGifSeen, onGifVisible: onGifVisible, onGifRightClick: onGifRightClick, user: user, hideAttribution: hideAttribution, noLink: noLink, borderRadius: borderRadius }));
                }),
