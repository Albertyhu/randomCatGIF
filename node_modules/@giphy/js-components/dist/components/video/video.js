...
var Video = function (_a) {
    var muted = _a.muted, _b = _a.loop, loop = _b === void 0 ? true : _b, onStateChange = _a.onStateChange, onTimeUpdate = _a.onTimeUpdate, onCanPlay = _a.onCanPlay, onFirstPlay = _a.onFirstPlay, onWaiting = _a.onWaiting, onMuted = _a.onMuted, onError = _a.onError, onEnded = _a.onEnded, onLoop = _a.onLoop, onQuartile = _a.onQuartile, onEndFullscreen = _a.onEndFullscreen, setVideoEl = _a.setVideoEl, gif = _a.gif, width = _a.width, height_ = _a.height, _c = _a.volume, volume = _c === void 0 ? 0.7 : _c, className = _a.className;
    var height = height_ || js_util_1.getGifHeight(gif, width);
    // state
    var _d = hooks_1.useState(js_util_1.getBestVideo(gif.video, width, height)), media = _d[0], setMedia = _d[1];
    var seek = hooks_1.useRef(0);
    if (!media) {
    ...
    var mountTime = hooks_1.useRef(Date.now());
    var hasPlayingFired = hooks_1.useRef(false);
    var loopNumber = hooks_1.useRef(0);
    var waitingCount = hooks_1.useRef(0);
    var quartilesFired = hooks_1.useRef(new Set());
    ...
    var videoEl = hooks_1.useRef(null);
    hooks_1.useEffect(function () {
    ...
    var _onError = hooks_1.useCallback(function () {
        var _a;
    ...
    var _onPlaying = hooks_1.useCallback(function () {
    ...
    var _onPaused = hooks_1.useCallback(function () { return onStateChange === null || onStateChange === void 0 ? void 0 : onStateChange('paused'); }, [onStateChange]);
    var _onTimeUpdate = hooks_1.useCallback(function () {
        var el = videoEl.current;
        if (el) {
    ...
    var _onCanPlay = hooks_1.useCallback(function () { return onCanPlay === null || onCanPlay === void 0 ? void 0 : onCanPlay(); }, [onCanPlay]);
    var _onWaiting = hooks_1.useCallback(function () {
        var el = videoEl.current;
    ...
    var _onEnded = hooks_1.useCallback(function () {
    ...
    var _onEndFullscreen = hooks_1.useCallback(function () { return onEndFullscreen === null || onEndFullscreen === void 0 ? void 0 : onEndFullscreen(); }, [onEndFullscreen]);
    var tryAutoPlayWithSound = hooks_1.useCallback(function (videoEl) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return (media === null || media === void 0 ? void 0 : media.url) ? (preact_1.h("video", { className: className, width: width, height: height, muted: muted, autoPlay: true, playsInline: true, ref: videoEl, src: media === null || media === void 0 ? void 0 : media.url })) : null;
};
